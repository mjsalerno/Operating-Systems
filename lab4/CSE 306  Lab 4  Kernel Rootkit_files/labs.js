...
window.onload = function() {
    ...
    for (var i = 0; i < nodes.length; i++) {
        ...
        if (nodes[i].tagName.match(/[hH][1-3]/)) {
            ...
            // Skip the top title
            if (depth === 0 && nodes[i].textContent.substr(0, 5) === "6.828")
                continue;
    ...
    sectionAddLink(refs, "Lab tools guide", "tools.html");
    sectionAddLink(refs, "80386 manual", "ref/i386/toc.htm");
    sectionAddLink(refs, "IA32");
    sectionAddLink(refs, "Basic architecture", "ref/ia32/IA32-1.pdf", "1em");
    sectionAddLink(refs, "Instruction set A-M", "ref/ia32/IA32-2A.pdf", "1em");
    sectionAddLink(refs, "Instruction set N-Z", "ref/ia32/IA32-2B.pdf", "1em");
    sectionAddLink(refs, "System programming 1", "ref/ia32/IA32-3A.pdf", "1em");
    sectionAddLink(refs, "System programming 2", "ref/ia32/IA32-3B.pdf", "1em");
